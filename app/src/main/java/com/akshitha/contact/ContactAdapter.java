...
//    private List<ContactEntity> contactsFiltered; // For search functionality
//    private OnItemClickListener itemClickListener;
//
//    public ContactAdapter(List<ContactEntity> contacts, OnItemClickListener itemClickListener) {
//        this.contacts = contacts;
//        this.contactsFiltered = new ArrayList<>(contacts); // Initialize filtered list with all contacts
//        this.itemClickListener = itemClickListener;
//    }
...
//    @Override
//    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
//        ContactEntity contact = contactsFiltered.get(position); // Use filtered list for display
//        holder.bind(contact);
//    }
//
//    @Override
...
//
//                if (filterPattern.isEmpty()) {
//                    filteredList.addAll(contacts); // If the search bar is empty, show all contacts
//                } else {
...
//            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
//                contactsFiltered.clear();
//                contactsFiltered.addAll((List<ContactEntity>) filterResults.values);
//                notifyDataSetChanged();
//            }
//        };
//    }
